...
program testTioga
  ...
  real*8 :: t0
  integer :: blockid,ibase,rbase,rcount
  logical :: iclip,exists
  integer :: ntypes
  integer :: nv1,nv2,nv3
  real*8 :: t1,t2,t_ini,t_fin
  integer :: i,n,m,ib,j,nblocks,rt
  real*8 :: xt(3),rnorm
  integer :: dcount,fcount
  integer :: ios1,ios2
  integer, allocatable :: receptorInfo(:),inode(:),receptors(:)
...
close(23)
!--------------------------------------------------------------------------------
!---------------------------Writing receptor info--------------------------------
!call tioga_getreceptorcount(rcount)
!allocate(receptors(rcount))
!call tioga_getreceptorinfo(ib,receptors,rcount)
!allocate(receptors(rcount))
!do rt = 1, rcount, 4
!    write(24,'(4I12)') receptors(rt), receptors(rt+1), receptors(rt+2), receptors(rt+3)
!enddo
!close(24)
!--------------------------------------------------------------------------------
200 continue    
  ...
  call cpu_time(t_fin)
  write(6,*) "Total Process time: ",t_fin-t_ini
  !
